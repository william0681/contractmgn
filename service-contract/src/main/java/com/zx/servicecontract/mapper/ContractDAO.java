...
import com.zx.servicecontract.model.ContractExample;
import com.zx.servicecontract.model.SimpleSeller;
...
public interface ContractDAO extends MyBatisBaseDao<Contract, Integer, ContractExample> {
    ...
    List<com.zx.servicecontract.vo.ContractList> getContractList(@Param("key") String key,
