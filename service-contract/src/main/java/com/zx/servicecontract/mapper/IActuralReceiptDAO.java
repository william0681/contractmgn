...
import com.zx.servicecontract.model.ActuralReceipt;
import com.zx.servicecontract.model.ActuralTicket;
import com.zx.servicecontract.model.ReceiptModel;
import com.zx.servicecontract.provider.ContractProvider;
...
public interface IActuralReceiptDAO {
    ...
    @Results({@Result(column = "id", property = "sellers", one = @One(select = "com.zx.servicecontract.mapper.IActuralReceiptDAO.getSellers"))})
