...
import com.zx.servicegateway.model.ActuralReceipt;
import com.zx.servicegateway.model.ActuralTicket;
import com.zx.servicegateway.model.ReceiptModel;
import com.zx.servicegateway.provider.ContractProvider;
...
public interface IActuralReceiptDAO {
    ...
    @Results({@Result(column = "id", property = "sellers", one = @One(select = "com.zx.servicegateway.mapper.IActuralReceiptDAO.getSellers"))})
